export default function SkillsSection() {
	const skills = ['Full stack development', 'Python', 'Embedded C++', 'AI & ML', 'Deep Learning', 'SQL', 'Salesforce Administrator', 'MS Office', 'Java', 'JavaScript', 'TypeScript', 'React', 'Node.js', 'Next.js', 'Git'];
